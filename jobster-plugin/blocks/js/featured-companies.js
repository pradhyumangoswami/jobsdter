(function(wp) {
    ...
    jQuery.ajax({
        ...
        url: ajaxurl,
        data: {
            'action': 'jobster_get_company_locations_industries'
        },
    ...
    function FeaturedCompaniesControl(props) {
        ...
        if (isSelected) {
            return el('div', 
                ...
                el('h3', 
                    {
                        className: 'featured-companies-placeholder-header'
                    },
                    title
                ),
                el('h4', 
                    {
                        className: 'featured-companies-placeholder-subheader'
                    },
                    subtitle
                ),
                featuredCompaniesOptions
            );
        } else {
            return el('div', 
                {
                ...
                el('div', 
                    {
                        className: 'featured-companies-placeholder-img'
                    }
                )
            );
        }
    ...
    registerBlockType('jobster-plugin/featured-companies', {
        title: __('Featured Companies', 'jobster'),
        description: __('Jobster featured companies block.', 'jobster'),
        icon: {
            src: 'building',
            foreground: '#007cba',
        },
        ...
        edit: withState({})(FeaturedCompaniesControl),
        save: function(props) {
            return null;
        },
    });
