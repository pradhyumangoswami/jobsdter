(function(wp) {
    ...
    function RecentJobsControl(props) {
        ...
        if (isSelected) {
            return el('div', 
                ...
                el('h3', 
                    {
                        className: 'recent-jobs-placeholder-header'
                    },
                    title
                ),
                el('h4', 
                    {
                        className: 'recent-jobs-placeholder-subheader'
                    },
                    subtitle
                ),
                recentJobsOptions
            ...
            return el('div', 
                ...
                el('div', 
                    {
                        className: 'recent-jobs-placeholder-img'
                    }
                )
            );
        }
    ...
    registerBlockType('jobster-plugin/recent-jobs', {
        title: __('Recent Jobs', 'jobster'),
        description: __('Jobster recent jobs block.', 'jobster'),
        icon: {
            src: 'portfolio',
            foreground: '#007cba',
        },
        ...
        edit: withState({})(RecentJobsControl),
        save: function(props) {
            return null;
        },
    });
