...
$this_url = jobster_get_page_link('candidate-dashboard-subscriptions.php'); ?>
                                ...
                                <div class="pxp-plans-card-1 <?php if ($membership_plan_popular == 1) { ?>pxp-plans-card-1-popular<?php } ?>">
                                    ...
                                    <div class="pxp-plans-card-1-bottom">
                                        <div class="pxp-plans-card-1-cta">
                                            ...
                                            <form method="post" action="<?php echo esc_url($this_url); ?>">
                                                <input type="hidden" name="candidate_plan_id" value="<?php echo esc_attr(get_the_ID()); ?>">
                                                <button class="pxp-plans-card-1-cta-btn" name="candidate_plan_submit" type="submit" <?php if ($candidate_plan_id == get_the_ID()) { ?>disabled<?php } ?>>
